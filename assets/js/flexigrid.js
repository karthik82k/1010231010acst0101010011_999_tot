...
(function ($) {
	...
	$.addFlex = function (t, p) {
		...
		p = $.extend({ //apply default properties
			...
			rp: 100000, //results per page
			rpOptions: [10, 15, 20, 30, 50, 100, 200, 300, 400, 500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000], //allowed per-page values
			title: false,
			idProperty: 'id',
...
//                                    setInterval(function(){move_back_button_to_bottom()}, 500);
                                });
			},
			doSearch: function () {
