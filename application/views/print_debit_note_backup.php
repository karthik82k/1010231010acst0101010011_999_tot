      ...
      <tr>
        <td>
          <table width="100%" align="center" style="border:solid 1px black; " >
            <tr>
              <td style="padding-left:50px;text-align: center; font-size: 15px; font-family: Arial; font-weight: bold; width:70%; border:solid 1px black;">DEBIT NOTE</td>
...
<br>
<center>
             <button class="btn btn-primary hidden-print" onclick="print_fun('print_panel');"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Close" onclick="window.location.href='<?php echo site_url('entry/manage_debitnote');?>'" />
