...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">MANAGE RECEIPT VOUCHER</li>   
     ...
     if($islock != 1) {
      ?>
     <a href="<?php echo site_url('/entry/receipt_voucher');?>" alt="ADD SALES QUOTATION" title="ADD SALES QUOTATION"><img src="https://test.newui.myddf.info/images/add.png" alt="ADD SALES QUOTATION" title="ADD SALES QUOTATION"/> ADD RECEIPT VOUCHER</a>
      <?php
     }
     ?>
     </div>   
<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                ...
                <td><a href="<?php echo site_url('/entry/edit_receipt_voucher/'.$val['VOUCHER_ID'].'/?pre='.urlencode($val['PREFIX']));?>"><span class="fa fa-pencil-square-o"></span></a>&nbsp;&nbsp;<?php if($no_cnt == 1){?><a href="<?php echo site_url('/entry/print_receipt_voucher/'.$val['VOUCHER_ID'].'/'.'/?pre='.urlencode($val['PREFIX']));?>"><span class="fa fa-print" aria-hidden="true"></span></a><?php }?></td>
            </tr>
            <?php
        }
            ?>
