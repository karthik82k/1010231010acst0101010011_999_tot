...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>RECEIPT VOUCHER</b></li> 
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_debit" id="frm_debit" action="<?php echo site_url('entry/add_receipt_voucher');?>" method="post" >
        <div class="textdata_myaccount">
          ...
          <tr class="to_clone1">
          <td>
            <select id="cmbledger_" name="cmb_ledger[]" class="tf4 form-control input-sm" style=" font-size: 16px;" >
