...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">DEBIT NOTE REGISTER</li>   
...
<table  class="table table-striped table-bordered" cellspacing="0" width="100%">        
        ...
        ?>
            <tr>
               ...
               &nbsp;&nbsp;<a href="<?php echo site_url('/report/debit_note_register/'.$val['MONTH'].'/'.$val['ACCOUNT_ID']);?>">View Details</a>
               <?php
             }
             ?>
               </td>
        ...
        ?>
            <tr>
               ...
               if($debit == 0 &&  $credit == 0){
                ...
                ?>&nbsp;&nbsp;<a href="<?php echo site_url('/report/debit_note_register/'.$val['MONTH']);?>">View Details</a>
                <?php
        ...
        ?>
            <tr>
               ...
               if(round($val['DEBITS']) == 0 &&  round($val['CREDITS']) == 0){
                ...
                ?>&nbsp;&nbsp;<a href="<?php echo site_url('/report/debit_note_register/'.$month.'/'.$val['ACCOUNT_ID'].'/?pre='.urlencode($val['PREFIX']).'&vouhcer_id='.$val['VOUCHER_ID']);?>">View Details</a>
                <?php
           ...
           <thead>
           <tr>
            <th colspan="6" style="text-align: center;">DEBIT NOTE</th>
          </tr>
          </thead>
           <tbody>
          <tr>
