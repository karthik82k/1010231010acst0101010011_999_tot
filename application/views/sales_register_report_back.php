...
<table  class="table-responsive table table-striped table-bordered" cellspacing="0" width="100%" style="width: 1300px;">        
        ...
        <?php
          ...
          if($prefix != 'DN' && $prefix != 'CN'){
            ...
            ?>
            <tr>
                <td style="width: 88px;"><?php echo date("d-m-Y",strtotime($val['DATE']));?></td>
                <td style="width: 98px;"><?php echo $val['PREFIX'].'0000'.$val['VOUCHER_ID'];?></td>
                <td style="width: 114px;"><?php echo $val['PREFIX'].$val['REFNUM'];?></td>
               ...
               <!-- <td style="width: 20px;"></td> -->
                ...
                <td style="width: 95px;"><?php echo number_format($interstate,2);?></td>
                 <td style="width: 85px;"><?php echo number_format($val['SGSTAMOUNT'],2);?></td>
                <td style="width: 85px;"><?php echo number_format($val['CGSTAMOUNT'],2);?></td>
                <td style="width: 85px;"><?php echo number_format($val['IGSTAMOUNT'],2);?></td>
                <?php if($export_col == 'y' ){
                  ?>
