  ...
  <div class="row">
      ...
      <tr>
        <td>
          <table width="100%" align="center" style="border:solid 1px black; " >
            <tr>
              <td style="padding-left:50px;text-align: center; font-size: 15px; font-family: Arial; font-weight: bold; width:70%; border:solid 1px black;">TAX INVOICE</td>
    ...
    <tr>
      ...
      <td style="width: 50%">
         <table width="100%" style="font-family: Arial; font-size: 14px;">
              <tr>
                <td colspan="2" style="text-align: left;"><b>Details of Consignee (Shipped To),</b></td>
              </tr>
              <tr>
                <td style="width: 15%; font-weight:bold;">Name:</td>
                <td><span ><?php echo $ACCOUNT;?></span></td>
              ...
              <tr>
                <td style="vertical-align:text-top;font-weight:bold;  ">Address:</td>
                <td style="word-wrap: break-word; vertical-align:text-top; height:60px;" colspan="3"><span><?php echo $party_shipping_address['ADDRESS1'].', '.$party_shipping_address['ADDRESS2'].', '.$party_shipping_address['DISTRICT'].' - '.$party_shipping_address['PINCODE'];?></span></td>
              </tr>
              <tr>
                <td style="font-weight:bold;"> GSTIN:</td>
                <td><span><?php echo $tinno;?></span>
              ...
              <tr>
                <td style="font-weight:bold;">State:</td>
                <td><span><?php echo $party_shipping_address['STATE'];?></span></td>
                <td style="width:90px; font-weight:bold;">State Code:</td>
                <td><span>29</span></td>
            </tr>
          </table>
      ...
      <div>
        <table cellspacing="3" rules="all" border="1" style="border: solid 1px black; font-family:Arial; font-size:13px; text-decoration:none; width:100%; color: black;">
          ...
          <tr style="height:3px;">
            ...
            <td align="right"><?php echo $cgst_amount;?></td>
            <td align="right"><?php echo $sgst_per;?></td>
            <td align="right"><?php echo $sgst_amount;?></td>
            <td align="right"><?php echo $igst_per;?></td>
            <td align="right"><?php echo $igst_amount;?></td>
...
<br>
<center>
             <button class="btn btn-primary hidden-print" onclick="print_fun('print_panel');"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Close" onclick="window.location.href='<?php echo site_url('entry/manage_sales_voucher');?>'" />
