...
<div class="container category">        
  <div class="row">
     <ol class = "breadcrumb">                
        <li style="color: red;">CREATE ANNOUNCEMENT</li>         
    </ol>      
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:3px 3px 3px 3px;">
            <form name="newregisterfrm" id="newregisterfrm" method="post" action="<?php echo site_url('admin/add_announcement');?>" >
                        ...
                        <div class="row" id="row1">
                            ...
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                             ...
                             <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                   <input type="text" class="form-control input-sm  input-group date" id="txt_end_date" name="txt_end_date" class="form-control" placeholder="dd-mm-yyyy" >
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-sm-6 col-xs-6">
                                <label for="emirate" class="control-label">Announcement<span class="textspandata">*</span></label>
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                    <textarea cols="100" rows="5" id="txt_announcement" name="txt_announcement" class="txtarahg" style="height: 42px;width: 90%;" maxlength="450"></textarea>
                                </div>
                            </div>                         
