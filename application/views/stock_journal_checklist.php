...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">STOCK JOURNAL CHECKLIST</li>   
...
<table  class="table table-striped table-bordered" cellspacing="0" width="100%">        
        ...
        ?>
            <tr>
                ...
                <td><?php echo  $val['INQTY'];?></td>
                <td><?php echo $val['OUTQTY'];?></td>
               <td><a href="<?php echo site_url('/mis_report/stock_journal_checklist/'.$val['month']);?>">View Details</a></td>
            </tr>
            <?php
        }
        ...
        ?>
            <tr>
                ...
                <td><?php echo  $val['INQTY'];?></td>
                <td><?php echo $val['OUTQTY'];?></td>
               <td><a href="<?php echo site_url('/mis_report/stock_journal_checklist/'.$val['MONTH'].'/'.$val['VOUCHER_ID'].'/?pre='.urlencode($val['PREFIX']));?>">View Details</a></td>
            </tr>
            <?php
        }
          ...
          ?>
              <tr>
                ...
                <td><?php echo $item;?></td>
                <td><?php echo $unit;?></td>
                <td><?php echo $value['INQTY'];?></td>   
                <td><?php echo $value['OUTQTY'];?></td>   
