          ...
          $.ajax({
            ...
            success: function(ret){
                ...
                if(val1[1] == ''){
                  ...
                  var cgst_amount = parseFloat(Number(cgst_amount).toFixed(2));
 ...
 $(".tf10").each(function() {
  ...
  if(voucher == ''){
    ...
    alert("Please Sales Type");
     $("#cmb_ledger").focus();
    return false;
  }else if(flag == 'empty' || flag_amount == 'empty') {
...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>SALES VOUCHER</b></li> 
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:1px 1px 1px 1px;">
            <form name="frm_sales_voucher" id="frm_sales_voucher" action="<?php echo site_url('entry/add_salesvoucher');?>" method="post" >
        <div class="textdata_myaccount">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">            
                ...
                <label for="emirate" class="col-md-12 control-label">Sales Voucher No <?php echo $v_type;?><span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                        <select id="cmb_voucher_type"  class="input-sm" name="cmb_voucher_type" style="width:50%;    border: 1px solid #555555 !important; font-size: 15px;">
                          <option value="">Select Type</option>
                          <?php foreach ($sn as $key ) {
                            if($v_type == trim($key['prefix'])){
                              echo "<option selected value='".$key['prefix']."'>".$key['prefix']."</option>";
                            }else{
                            echo "<option value='".$key['prefix']."'>".$key['prefix']."</option>";
                            }
                          }
                          ?>
                        </select>                   
                        <input type="text" class=" input-sm" name="txt_serial_no" id="txt_serial_no" value="<?php echo $ser_num;?>" readonly style="    border: 1px solid #555555 !important; width:46%;  background-color: #f5f5f5;  font-size: 15px;">
                ...
                <label for="emirate" class="col-md-12 control-label ">Bill No<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                       <input type="number" name="txt_bill_no" id="txt_bill_no" class=" input-sm"  value="<?php echo $bill;?>" style="width:78%; font-size:18px;    border: 1px solid #555555 !important; " maxlength = "10" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" >
                    </div>
                ...
                <label for="emirate" class="col-md-12 control-label ">Date<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group date" id="txt_date" name="txt_date" class="form-control" placeholder="dd-mm-yyyy" style="    border: 1px solid #555555 !important; width:100%;  font-size: 14px;">
                       
                    </div>
                </div>
                <div class="form-group col-md-1 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Last Bill No<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm" id="txt_last_bill" name="txt_last_bill" class="form-control" readonly style="width:100%;    border: 1px solid #555555 !important; background-color: #f5f5f5;" value="<?php echo $last_bill[0]['SerialNo'];?>">
                       
                    </div>
                </div >
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Transport Mode<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                    <select name="txt_transport_mode" id="txt_transport_mode" class="input-sm" style="width:90%;    border: 1px solid #555555 !important;">
                        <option value="" selected="selected">Select Transport Mode</option>
                        <?php foreach ($transport_mode as $row) {                             
                ...
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Vehicle Number<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                       <input type="text" name="txt_vechicle_no" id="txt_vechicle_no" class=" input-sm" maxlength = "25" value="" style="width:95%;    border: 1px solid #555555 !important; " >
                    </div>
               ...
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#item-modal" style="height: 20px; padding-top:0px; padding-right:5px; padding-left:5px;">Add Item</button></div>
                ...
                <label for="emirate" class="col-md-12 control-label ">Current Balance<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm" id="txt_bance" name="txt_bance" class="form-control" readonly value="<?php echo $ac_cur_val;?>" style=" font-size: 16px;" >
                ...
                <label for="emirate" class="col-md-12 control-label">PO Number<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                       <select name="cmb_so_number" id="cmb_so_number" class="input-sm" style="width:90%;    border: 1px solid #555555 !important;">
                        <option value="" selected="selected">Select PO Number</option>
                        <?php
                          foreach ($purchase_order as $key) {
                             if($purchase_id == $key['VOUCHER_ID']){
                              echo "<option value='".$key['VOUCHER_ID']."' selected>".$key['PURCHASE_ORDER_NO']."</option>";
                             }else{
                              echo "<option value='".$key['VOUCHER_ID']."'>".$key['PURCHASE_ORDER_NO']."</option>";
                            }                            
                          }
                        ?>
                      </select> 
                ...
                <div class="form-group col-md-1 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Cr. Period<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="number" class="input-sm" id="txt_validity" name="txt_validity" class="form-control" style="width:80%;    border: 1px solid #555555 !important;" value="<?php echo $validity;?>" maxlength = "3" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                       
                    </div>
                </div>
                 <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Date of Supply<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group date" id="txt_date_of_supply" name="txt_date_of_supply" class="form-control" placeholder="dd-mm-yyyy" style="    border: 1px solid #555555 !important; width:80%;">
                 ...
                 <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group col-md-5 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Sales Type<span class="textspandata">*</span></label>
              ...
              <div class="form-group col-md-3 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Shipping Address<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                       <select name="cmb_shipping" id="cmb_shipping" class="input-sm" style="width:100%;    border: 1px solid #555555 !important;">
                ...
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">PO NO.<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group" id="txt_po_manual" name="txt_po_manual" class="form-control" maxlength="35" style="border: 1px solid #555555 !important; width:100%;">
                       
                    </div>
                </div>
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">DC NO.<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group" id="txt_dc_no" name="txt_dc_no" class="form-control" maxlength="20" style="border: 1px solid #555555 !important; width:100%;">
          ...
          <td style="width:330px;" >
            <select id="cmbitemname_" name="cmb_item_name[]" class="tf4 txtara_lst input_grid" style="width:310px;" >
              <option value="" selected>select Item</option>
                <?php foreach ($item as $row) {
                  echo "<option value='".$row['ID']."'>".$row['NAME']."</option>"; 
                }?>
            </select><a href="#" title="" alt="" id="txtstock_" class="tf9" ><i class="fa fa-th"  aria-hidden="true"></i></a>
          </td>
          <td >
             <select name="cmb_unit[]" id="cmbunit_" class="tf6 txtara_lst input_grid" style="width:50px; pointer-events: none; " >
          ...
          <td>
              <input name="txt_qty[]" type="number" class="tf5 addeb_input_txtfld input_grid" id="txtqty_" value="0" style="width:72px;"/>
          </td>
          <td>
              <input name="txt_unit_price[]" type="number" class="tf7 addeb_input_txtfld input_grid" id="txtunitprice_" value="0" style="width:72px;"/>
          </td>               
          
          <td>
              <input name="txt_amount[]" type="text" class="tf10 addeb_input_txtfld input_grid" id="txtamount_" value="0" readonly style="width:90px;"/>
          </td>
          <td>
              <input name="txt_discount[]" type="number" class="tf8 addeb_input_txtfld input_grid" id="txtdiscount_" value="0" style="width:50px;"/>
          </td>
          <td>
              <input name="txt_sgst[]" type="text" class="tf11 addeb_input_txtfld input_grid" id="txtsgst_" value="0" readonly style="width:75px;"/>
              <input name="txt_sgst_per[]" type="hidden" class="tf15 addeb_input_txtfld input_grid" id="txtsgstper_" value="0" />
          </td>
          <td>
              <input name="txt_cgst[]" type="text" class="tf12 addeb_input_txtfld input_grid" id="txtcgst_" value="0" readonly style="width:75px;"/>
              <input name="txt_cgst_per[]" type="hidden" class="tf16 addeb_input_txtfld input_grid" id="txtcgstper_" value="0"/>
          </td>
          <td>
              <input name="txt_igst[]" type="text" class="tf13 addeb_input_txtfld input_grid" id="txtigst_" value="0" readonly style="width:75px;"/>
              <input name="txt_igst_per[]" type="hidden" class="tf17 addeb_input_txtfld input_grid" id="txtigstper_" value="0"/>
          </td>
          <td>
              <input name="txt_total[]" type="text" class="tf14 addeb_input_txtfld input_grid" id="txttotal_" value="0" readonly style="width:90px;"/>
          </td>
        ...
        <tr class="to_clone1">
          ...
          <td >
             <select name="cmb_unit[]" id="cmbunit_<?php echo $j;?>" class="tf6 txtara_lst input_grid" style="width:50px; pointer-events: none;">
                  <option value="" selected="selected">Select Unit</option><?php
                    foreach ($unit as $data) {
                      if($unit_id == $data['ID']){
          ...
          <td>
          <select name="cmb_tax[]" id="cmbtax_<?php echo $j;?>" class="tf3 txtara_lst input_grid" style="width:75px; font-size: 12px; pointer-events: none;" >
          <option value="" selected="selected">Tax</option><?php
                    foreach ($tax as $data) {
                      if($tax_id == $data['ID']) {
          ...
          <td>
              <input name="txt_discount[]" type="number" class="tf8 addeb_input_txtfld input_grid" id="txtdiscount_<?php echo $j;?>" value="0" style="width:50px;"/>
          </td>
          <td>
          ...
          <td>
              <input name="txt_cgst[]" type="text" class="tf12 addeb_input_txtfld input_grid" id="txtcgst_<?php echo $j;?>" value="<?php echo $cgst_amount;?>" readonly style="width:75px;"/>
          ...
          <td>
              <input name="txt_igst[]" type="text" class="tf13 addeb_input_txtfld input_grid" id="txtigst_<?php echo $j;?>" value="<?php echo $igst_amount;?>" readonly style="width:75px;"/>
          ...
          <td>
              <input name="txt_total[]" type="text" class="tf14 addeb_input_txtfld input_grid" id="txttotal_<?php echo $j;?>" value="<?php echo $total;?>" readonly style="width:90px;"/>
          </td>
          <!--<td align="center">
              <img src="https://test.newui.myddf.info/images/add.png" name="multiple" id="multiple" class="f_moreFilter" alt="Add Multiple" title="Add Multiple" /></span> 
              <span class="f_deleteimg"></span>
        ...
        $net_total = round($total_final);
        $round_off = $net_total - $total_final;
        } ?>     
      </tbody>
    </table>
  </div> 
     <div class="col-md-12 col-sm-12 col-xs-12">   
                ...
                <label for="emirate" class="col-md-12 control-label">DISCOUNT <span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                        <input name="txt_total_discount" type="text" id="txt_total_discount" class="input-sm form-control" readonly style="   background-color: #f5f5f5;  border: 1px solid #555555 !important;  font-size: 16px;" value="0">
                    </div>
                </div>
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
            ...
            <div style="height:5px;"></div>
                  <div class="text-center">
                    ...
                    <input type="reset" class="btn btn-primary" name="reset" id="reset" value="Reset" />&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Cancel" onclick="window.location.href='<?php echo site_url('entry/manage_sales_voucher');?>'" />
                </div>          
            </div>  
        </form>       
    </div>    
...
$("#cmb_so_number").change(function(){
  ...
  var sn =  $('#txt_serial_no').val();
  var bill = $('#txt_bill_no').val();
  var acc = $('#cmb_account_group').val();  
    window.location='<?php echo site_url(); ?>entry/sales_voucher/' + value +'?v_type='+voucher_type +'&sn='+sn+'&bill='+bill+'&acc='+acc;
    ...
    $(".f_moreFilter").click(function() {
      ...
      if(flag == 'empty' || item_flag == 'empty' || flag_amount == 'empty' ){
    ...
    //  var tf17 = new_div1.find('.tf3').eq(0);
...
$("#cmb_account_group").change(function () {
    ...
    if(account_id != '') {
        ...
        $.ajax({
            url  :"<?php echo site_url(); ?>/entry/get_sales_order_sales",
            data : {account_id: account_id},
            success: function(ret_order){
                ret_order = jQuery.parseJSON(ret_order);               
                $('#cmb_so_number').empty();
                var order = $('#cmb_so_number');
                var opt = document.createElement('option');
                ...
                for(var key in ret_order){ 
                    var opt = document.createElement('option');
                    opt.text = ret_order[key]['PURCHASE_ORDER_NO'];
         ...
         $.ajax({
            url  :"<?php echo site_url(); ?>/entry/get_current_account",
            data : {account_id: account_id},
            success: function(ret_cur){
                ret_cur = jQuery.parseJSON(ret_cur);               
               
              var acc = ret_cur['curr'];
              $('#txt_bance').val(acc);
 ...
 $("#txt_bill_no").blur(function () {
       var bill_no = $(this).val();
        $.ajax({
            url  :"<?php echo site_url(); ?>/entry/check_sales_bill",
            data : {bill_no: bill_no},
            success: function(ret){              
              if(ret == 'exists') {
                jAlert("The Bill No is already exits!!", "Alert");
                $("#txt_bill_no").val('');
              }
            }
        })
