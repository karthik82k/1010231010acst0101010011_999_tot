...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">DEBIT NOTE</li>   
        ...
        <td style="border-top: 1px solid #555555; height: 50px;" >
          ...
          <table width="100%" align="center" >
            <tr>
              ...
              <td style="padding-left:50px;text-align: center; font-size: 18px; font-family: Arial; font-weight: bold; width:50%; ">DEBIT NOTE</td>
...
<br>
<center>
             <button class="btn btn-primary hidden-print" id='btn_print'><span class="glyphicon glyphicon-print"  aria-hidden="true"></span> Print</button>&nbsp;&nbsp;<input type="button" class="btn btn-primary  hidden-print" name="reset" id="reset" value="Close" onclick="window.location.href='<?php echo site_url('entry/manage_debitnote');?>'" />
...
$("#btn_print").click(function () {
  ...
  $.ajax({
            ...
            data : {prefix: prefix, voucher_id: voucher_id, voucher_type: 'DN'},
