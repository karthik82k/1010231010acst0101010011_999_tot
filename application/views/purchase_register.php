...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">PURCHASE REGISTER</li>  
...
<table  class="table table-striped table-bordered" cellspacing="0" width="100%">        
        <?php       
           if(!empty($purchase_register_details)){
          ?>
          <thead>
            <tr>
        ...
        <?php
          ...
          $total_dr = 0;
          $balance_total = 0;
            foreach ($purchase_register_details as $val) {
               $balance_row = 0;
               $balance = 0;
        ...
        ?>
            <tr>
               ...
               &nbsp;&nbsp;<a href="<?php echo site_url('/report/purchase_register/'.$val['MONTH'].'/'.$val['ACCOUNT_ID']);?>">View Details</a>
               <?php
             }
             ?>
               </td>
        ...
        ?>
            <tr>
               ...
               if($debit == 0 &&  $credit == 0){
                ...
                ?>&nbsp;&nbsp;<a href="<?php echo site_url('/report/purchase_register/'.$val['MONTH']);?>">View Details</a>
                <?php
          ...
          <?php            
          }else if(!empty($purchase_register_month)){
            ?>
            <thead>
             <tr>
        ...
        <?php
          ...
          $total_dr = 0;
          $balance_total = 0;
            foreach ($purchase_register_month as $val) {
              if($val['ACCOUNT_ID'] != ''){
               $balance_row = 0;
               $balance = 0;
               //$account = $val['DATE'];
        ...
        ?>
            <tr>
               ...
               if(round($val['DEBITS']) == 0 &&  round($val['CREDITS']) == 0){
                ...
                ?>&nbsp;&nbsp;<a href="<?php echo site_url('/report/purchase_register/'.$month.'/'.$val['ACCOUNT_ID'].'/?pre='.urlencode($val['PREFIX']).'&vouhcer_id='.$val['VOUCHER_ID']);?>">View Details</a>
                <?php
            ...
            <?php
          }else if(!empty($purchase_register_prefix)){
           ?>          
           <thead>
           <tr>
            <th colspan="6" style="text-align: center;">PURCHASE VOUCHER</th>
          </tr>
          </thead>
           <tbody>
          <tr>
          ...
          $total_final = 0;
           $total = 0;
          foreach ($purchase_register_prefix as  $value) {
          $item = $value['ITEM'];
          $unit = $value['UNIT']; 
          $rate = $value['RATE'];
          ...
          ?>
            ...
            <tr>
              <td colspan="8">
              <table  class="table table-striped table-bordered" >
               <?php  if($type_sales == 'DOMESTIC PURCHASE'){              
              ?>
              <tr>
