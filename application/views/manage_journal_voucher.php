...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">MANAGE JOURNAL VOUCHER</li>        
     ...
     if($islock != 1) {
      ?>
     <a href="<?php echo site_url('/entry/journal_voucher/');?>" alt="ADD JOURNAL VOUCHER" title="ADD JOURNAL VOUCHER"><img src="https://test.newui.myddf.info/images/add.png" alt="ADD JOURNAL VOUCHER" title="ADD JOURNAL VOUCHER"/> ADD JOURNAL VOUCHER</a>
      <?php
     }
     ?>
     </div>   
<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <?php
          foreach ($journal_voucher as $val) {   
             $inr_total = number_format($val['AMOUNT'],2);         
        ?>
            <tr>
                ...
                <td><a href="<?php echo site_url('/entry/edit_journal_voucher/'.$val['VOUCHER_ID'].'/?pre='.urlencode($val['PREFIX']));?>"><span class="fa fa-pencil-square-o"></span></a></td>
            </tr>
        <?php
         }
        ?>
