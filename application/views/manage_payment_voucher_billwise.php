...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">MANAGE BILLWISE PAYMENT VOUCHER</li>  
     ...
     if($islock != 1) {
      ?>
     <a href="<?php echo site_url('/entry/payment_voucher_billwise');?>" alt="ADD BILLWISE PAYMENT VOUCHER" title="ADD BILLWISE PAYMENT VOUCHER"><img src="https://test.newui.myddf.info/images/add.png" alt="ADD BILLWISE PAYMENT VOUCHER" title="ADD SALES QUOTATION"/> ADD BILLWISE PAYMENT VOUCHER</a>
      <?php
     }
     ?>
     </div>   
<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                ...
                <td><a href="<?php echo site_url('/entry/edit_payment_voucher_billwise/'.$val['VOUCHER_ID'].'/?pre='.urlencode($val['PREFIX']));?>"><span class="fa fa-pencil-square-o"></span></a></td>
            </tr>
            <?php
        }
            ?>
