...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">CASH DAY BOOK</li>  
...
<table  class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
               ...
               &nbsp;&nbsp;<a href="<?php echo site_url('/report/cash_book/'.$val['ACCOUNT_ID'].'/?close='.urlencode($opening_bal));?>">View Details</a>
               <?php
             }
             ?>
               </td>
            ...
            <?php
          }else if(!empty($cash_book_details)){
            ?>
              <tr>
            <th colspan="4" style="text-align: center; font-weight: bold; font-size: 16px;" >
            <?php
        ...
        <?php
         ...
         // $balance_total = 0;
           ...
           //  $balance_row =  $opening_bal;
            ...
            foreach ($cash_book_details as $val) {
               $balance_row = 0;
        ...
        ?>
            <tr>
               ...
               if($debit == 0 &&  $credit == 0){
                ...
                ?>&nbsp;&nbsp;<a href="<?php echo site_url('/report/cash_book/'.$ACCOUNT_ID.'/'.$val['MONTH'].'/?close='.urlencode($opening_bal_row));?>">View Details</a>
                <?php
        ...
        <?php
          ...
          $total_dr = 0;
          $balance_total = 0;
            foreach ($cash_book_month as $val) {
               $balance_row = 0;
               $balance = 0;
               $account = $val['DATE'];
               $total_dr =  $total_dr + round($val['DEBITS'],2);
