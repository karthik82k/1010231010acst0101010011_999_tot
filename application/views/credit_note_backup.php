           ...
           <!-- <div class="form-group col-md-5 col-sm-6 col-xs-6">
              ...
              <?php foreach ($tax as $row) {
                ...
                <label for="emirate" class="col-md-12 control-label">SGST<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                        <input name="txt_sgst" id="txt_sgst" type="number" class="input-sm" readonly style="    border: 1px solid #555555 !important; width: 75%;  background-color: #f5f5f5;" >
                    </div>
                </div>
                <div class="form-group col-md-1 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label">CGST<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                       <input name="txt_cgst" id="txt_cgst" type="number"  class="input-sm" readonly style="    border: 1px solid #555555 !important; width: 75%;  background-color: #f5f5f5;" >
                    </div>
                </div>
                <div class="form-group col-md-1 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label">IGST<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                       <input name="txt_igst" id="txt_igst" type="number" class="input-sm" readonly style="    border: 1px solid #555555 !important; width: 75%;  background-color: #f5f5f5;">
                    </div>
                </div>
                </div>
                  <div class="col-md-12 col-sm-12 col-xs-12">
