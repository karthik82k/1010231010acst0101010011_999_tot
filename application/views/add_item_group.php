...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">ADD GROUP TAX</li>        
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_item" id="frm_item" action="<?php echo site_url('inventory/create_item_group');?>" method="post" >
  ...
  $(document).ready(function() {
     ...
     $("#txt_item_name").blur(function () {
       var item_name = $(this).val();
        $.ajax({
            url  :"<?php echo site_url(); ?>/inventory/item_group_name",
            data : {item_group_name: item_name},
