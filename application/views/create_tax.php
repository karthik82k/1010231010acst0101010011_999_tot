...
<div class="container category">        
  <div class="row">
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:3px 3px 3px 3px;">
            <form name="newregisterfrm" id="newregisterfrm" method="post" action="<?php echo site_url('master/add_tax');?>" >
                        ...
                        <div class="row" id="row1">
                            ...
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                    <input type="text" class="form-control input-sm" id="txt_tax_type" name="txt_tax_type" maxlength="10">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                    <input type="number" class="form-control input-sm" id="txt_cgst" name="txt_cgst" maxlength="50">
                                </div>
                            </div>
                             <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                <label for="emirate" class="control-label">SGST<span class="textspandata">*</span></label>
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                    <input type="number" class="form-control input-sm" id="txt_sgst" name="txt_sgst" maxlength="50" >
                                </div>
                            </div>
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                <label for="emirate" class="control-label">IGST<span class="textspandata">*</span></label>
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                    <input type="number" class="form-control input-sm" id="txt_igst" name="txt_igst" maxlength="200">
                                </div>
                            </div>                            
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                <label for="emirate" class="control-label">Export<span class="textspandata">*</span></label>
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                    <input type="number" class="form-control input-sm" id="txt_export" name="txt_export" maxlength="50">
                                </div>
                            </div>
                            <div class="form-group col-md-4 col-sm-6 col-xs-6">
                                <label for="emirate" class="control-label">Others<span class="textspandata">*</span></label>
                                <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                                    <input type="number" class="form-control input-sm" id="txt_others" name="txt_others" maxlength="20">
                                </div>
                            </div>
