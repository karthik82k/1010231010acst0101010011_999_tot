...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">
        <li style="color: red;">MANAGE ITEM GROUP</li>
     ...
     <div id="profilestatus" style="text-align: right;"><a href="<?php echo site_url('/master/add_serial');?>" alt="ADD PREFIX" title="ADD PREFIX"><img src="https://test.newui.myddf.info/images/add.png" alt="ADD PREFIX" title="ADD PREFIX"/> ADD PREFIX</a></div>   
<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                ...
                <td><?php echo $voucher_type[$val['VoucherType']];?></td>
