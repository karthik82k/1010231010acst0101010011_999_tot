...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">ADD PREFIX</li>  
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_item" id="frm_item" action="<?php echo site_url('master/create_serial');?>" method="post" >
        <div class="textdata_myaccount">
            <fieldset class="well" id="well1">
            <div class="row" id="row1">
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-4 control-label">Prefix<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9" style="align:left;">
                        <input type="text" class="form-control input-sm" id="txt_prefix" name="txt_prefix" maxlength="20">
                    </div>
                </div>
                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-4 control-label">Voucher Type<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9" style="align:left;">
                        <select name="cmb_type" id="cmb_type"  class="form-control input-sm">
                           <option value="" selected>Select Voucher Type</option> 
              <?php foreach ($voucher as $row) {
                  echo "<option value='".$row['VoucherType']."'>".$row['Description']."</option>"; 
                }?>  
                        </select>
                    </div>
                </div>
