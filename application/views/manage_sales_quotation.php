...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">MANAGE PROFORMA INVOICE</li>  
     ...
     if($islock != 1) {
      ?>
     <a href="<?php echo site_url('/entry/sales_quotation');?>" alt="ADD SALES QUOTATION" title="ADD SALES QUOTATION"><img src="https://test.newui.myddf.info/images/add.png" alt="ADD SALES QUOTATION" title="ADD SALES QUOTATION"/> ADD PROFORMA INVOICE</a>
      <?php
     }
     ?>
     </div>   
<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                ...
                <td><?php echo $val['QUOTATION_REFERENCE'];?></td>
                ...
                <td><a href="<?php echo site_url('/entry/edit_salesquotation/'.$val['VOUCHER_ID'].'/?pre='.urlencode($val['PREFIX']));?>"><span class="fa fa-pencil-square-o"></span></a>&nbsp;&nbsp;<a href="<?php echo site_url('/entry/print_proforma_invoice/'.$val['VOUCHER_ID'].'/'.'/?pre='.urlencode($val['PREFIX']));?>"><span class="fa fa-print" aria-hidden="true"></span></a></td>
            </tr>
            <?php
        }
            ?>
