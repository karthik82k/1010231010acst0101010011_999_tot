...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">PAYMENT VOUCHER</li> 
 ...
 <div class="table-responsive" id="print_panel" style="background-color: #cccccc;">
     <table border="0" style="font-family: Arial;font-size:10px; background-color: #ffffff;" align="center" width="900px">
      ...
      <table width="100%" style="font-family: Arial; font-size: 14px; margin-left: 5px;" border="0">
      <tr>
      <td align="center" colspan="2">
      <table width="100%" style="font-family: Arial; font-size: 14px;" border="0">
        <tr>
        ...
        <td style="border-top: 0px solid #555555; height: 50px; text-align: center; font-size: 18px; font-family: Arial; font-weight: bold;" >
          ...
          <table width="100%" align="center" >
            <tr>
              ...
              <td style="padding-left:50px;text-align: center; font-size: 18px; font-family: Arial; font-weight: bold; width:30%; ">PAYMENT VOUCHER</td>
   ...
   <td style="height: 10px;">
        ...
        <tr>
          ...
          <td valign="top" width="100%">
            <table width="100%">
              <tr>
                <td style="width: 14%; font-weight: bold; height: 30px; font-size: 16px; vertical-align:bottom;">Debit A/c</td>
...
<br>
<center>
           <button class="btn btn-primary hidden-print" id='btn_print'><span class="glyphicon glyphicon-print "  aria-hidden="true"></span> Print</button>&nbsp;&nbsp;<input type="button" class="btn btn-primary  hidden-print" name="reset" id="reset" value="Close" onclick="window.location.href='<?php echo site_url('entry/manage_payment_voucher');?>'" />
