...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>EDIT SALES VOUCHER</b></li> 
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:1px 1px 1px 1px;">
            <form name="frm_sales_voucher" id="frm_sales_voucher" action="<?php echo site_url('entry/update_salesvoucher');?>" method="post" >
        <div class="textdata_myaccount">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">            
                ...
                <label for="emirate" class="col-md-12 control-label">Sales Voucher No<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                        <input type="text" class="input-sm" id="cmb_voucher_type" name="cmb_voucher_type" value="<?php echo $prefix; ?>" readonly  style="width:35%;    border: 1px solid #555555 !important;  background-color: #f5f5f5; font-size: 15px;">                    
                        <input type="text" class=" input-sm" name="txt_serial_no" id="txt_serial_no" value="<?php echo '0000'.$sn; ?>" readonly style="    border: 1px solid #555555 !important; width:54%;  background-color: #f5f5f5; font-size: 15px;">
                ...
                <label for="emirate" class="col-md-12 control-label ">Bill No<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                       <input type="text" name="txt_bill_no" id="txt_bill_no" class="input-sm"  maxlength = "15" value="<?php echo $bill_no;?>" readonly  style="width:78%; font-size:18px;    border: 1px solid #555555 !important; background-color: #f5f5f5; ">
                    </div>
                ...
                <label for="emirate" class="col-md-12 control-label ">Date<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group date" id="txt_date" name="txt_date" class="form-control" placeholder="dd-mm-yyyy" value="<?php echo $date;?>" style="    border: 1px solid #555555 !important; width:100%;  background-color: #f5f5f5; font-size: 14px;">
                ...
                <label for="emirate" class="col-md-12 control-label ">Vehicle Number<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                       <input type="text" name="txt_vechicle_no" id="txt_vechicle_no" class=" input-sm" maxlength = "25" style="width:95%;    border: 1px solid #555555 !important; " value="<?php echo $vehicle_no;?>">
                    </div>
               ...
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#item-modal" style="height: 20px; padding-top:0px; padding-right:5px; padding-left:5px;">Add Item</button></div>
                ...
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label ">Cur Bal.<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                ...
                <label for="emirate" class="col-md-12 control-label">PO Number<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">   
                      <input name="cmb_so_number" id="cmb_so_number" type="hidden" value="<?php echo $purchase_id;?>">                     
                       <select name="cmb_so_number1" id="cmb_so_number1" class="input-sm" style="width:80%;    border: 1px solid #555555 !important;" disabled="true">
                ...
                <label for="emirate" class="col-md-12 control-label ">Cr. Period<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm" class="form-control" style="width:80%;    border: 1px solid #555555 !important;" id="txt_validity" name="txt_validity" class="form-control"  value="<?php echo $credit_period;?>" maxlength = "3" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                ...
                <label for="emirate" class="col-md-12 control-label ">Date of Supply<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group date" id="txt_date_of_supply" name="txt_date_of_supply" class="form-control" placeholder="dd-mm-yyyy" style="    border: 1px solid #555555 !important; width:80%;" value="<?php echo $date_of_supply;?>">
               ...
               <div class="form-group col-md-3 col-sm-6 col-xs-6">
                ...
                <label for="emirate" class="col-md-12 control-label ">PO NO.<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group" id="txt_po_manual" name="txt_po_manual" class="form-control" maxlength="35" style="border: 1px solid #555555 !important; width:100%;" value="<?php echo $po_manual;?>" >
                ...
                <label for="emirate" class="col-md-12 control-label ">DC NO.<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm  input-group" id="txt_dc_no" name="txt_dc_no" class="form-control" maxlength="20" style="border: 1px solid #555555 !important; width:100%;" value="<?php echo $dc_no;?>">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">   
            ...
            <div style="height:5px;"></div>
                  <div class="text-center">
                    ...
                    <input type="reset" class="btn btn-primary" name="reset" id="reset" value="Reset" />&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Cancel" onclick="window.location.href='<?php echo site_url('entry/manage_sales_voucher');?>'" />&nbsp;&nbsp;<!--<input type="button" class="btn btn-primary" name="btn_delete" id="btn_delete" value="Delete"  onclick=" if (confirm('Do you want delete this voucher?')){window.location.href='<?php echo site_url('/entry/delete_sales_voucher/'.$sn.'/'.'/?pre='.urlencode($prefix));?>';}else{event.stopPropagation(); event.preventDefault();}; "/> -->
                </div>          
            </div>  
        </form>       
    </div>    
