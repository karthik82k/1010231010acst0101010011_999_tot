...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">MANAGE ANNOUNCEMENTS</li>         
    </ol> 
     <div id="profilestatus" style="text-align: right;"><a href="<?php echo site_url('/admin/create_announcements');?>" alt="ADD ANNOUNCEMENTS" title="ADD ANNOUNCEMENTS"><img src="https://test.newui.myddf.info/images/add.png" alt="ADD ANNOUNCEMENTS" title="ADD ANNOUNCEMENTS"/> ADD ANNOUNCEMENTS</a></div>   
<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                <td><?php if($val['COMPANY'] != ''){ echo $val['COMPANY']; }else{ echo 'ALL COMPANY'; } ?></td>
                <td ><?php echo $val['Announcement'] ;?></td>
                <td><?php echo date("d-m-Y",strtotime($val['STARTDATE']));?></td>
                <td><?php echo date("d-m-Y",strtotime($val['ENDDATE']));?></td>
                <td><a href="<?php echo site_url('/admin/edit_announcement/'.$val['ANNOUNCE_ID']);?>"><span class="fa fa-pencil-square-o"></span></a></td>
            </tr>
            <?php
        }
            ?>
