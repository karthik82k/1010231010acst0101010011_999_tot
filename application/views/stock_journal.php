...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>STOCK JOURNAL</b></li>   
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_debit" id="frm_debit" action="<?php echo site_url('entry/add_stock_journal');?>" method="post" >
        <div class="textdata_myaccount">
          ...
          <td><span id="txtstock_" class="tf9" ></span></a></td>
          
         
          
          <td>
              <input name="txt_outward[]" type="number" class="tf14 addeb_input_txtfld input_grid" id="txtoutward_" value="0"  maxlength = "10" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
          </td>
          <td>
              <select id="cmbtype_" name="cmb_type[]" class="tf8 form-control input-sm" style="font-size: 16px;" >
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">               
                ...
                <label for="emirate" class="col-md-12 control-label">TOTAL INWARD<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9">
                        <input name="txt_inward_total" type="number" id="txt_inward_total" class="input-sm" readonly style="background-color: #f5f5f5; border: 1px solid #555555 !important; font-size: 16px;" value="0" >
                    </div>
                </div>
                <div class="form-group col-md-3 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label">TOTAL OUTWARD<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9">
                        <input name="txt_outward_total" type="number" id="txt_outward_total" class="input-sm" readonly style=" background-color: #f5f5f5; border: 1px solid #555555 !important; font-size: 16px;" value="0" >
                    </div>
                </div>
            </div>         
          </fieldset>      
