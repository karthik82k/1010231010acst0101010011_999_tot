        ...
        <td style="border-top: 1px solid #555555; height: 50px;" >
          ...
          <table width="100%" align="center" >
            <tr>
              ...
              <td style="padding-left:50px;text-align: center; font-size: 18px; font-family: Arial; font-weight: bold; width:30%; ">EXPORT INVOICE</td>
      ...
      <td style="width: 50%; vertical-align: top;">
        ...
        <table  border="1" style=" font-family:Arial; font-size:14px; text-decoration:none; width:900px; color: black; background-color: #ffffff;" align="center" >
          ...
          <tr align="center" style=" height:40px; background-color: #000000; color: #ffffff; border-top: 1px solid #555555; border-bottom: 1px solid #555555">
           ...
           ?>
            <th style="text-align: right;">Total Amount <br> <?php echo $currency;?></th>
          </tr>
          <?php
          ...
          <tr style="height:36px; page-break-inside: avoid !important;">
            ...
            <td align="left" style="width: 70px; font-weight: bold; text-align: center;"><?php echo number_format($rate,2);?></td>
            <td align="left" style="width: 90px; font-weight: bold; text-align: center;"><?php echo number_format($amount,2);?></td>
                  ...
                  <table cellspacing="0" border="0" style="font-size:13px;width:100%; border-collapse:collapse;">
                   ...
                   <!-- <tr>
                    ...
                    <tr>
                      ...
                      <td align="right" style="font-weight:bold; font-size: 15px; "><?php echo number_format($final_total_with_tax_amount,2);?></td>
                    </tr>
                  </table>
                </div>
              </td>
