...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">EDIT ITEM</li>
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_item" id="frm_item" action="<?php echo site_url('inventory/update_item');?>" method="post" >
        <div class="textdata_myaccount">
            <fieldset class="well" id="well1">
            <div class="row" id="row1">
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                <input type="hidden"  name="cmb_financial" id="cmb_financial" value="<?php echo $item_data[0]['FINANCIALYEAR_ID'];?>">
                <label for="emirate" class="col-md-4 control-label">Item Name<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9" style="align:left;">
                        <input type="text" class="form-control input-sm" id="txt_item_name" name="txt_item_name" maxlength="50" value="<?php echo $item_data[0]['NAME'];?>">
                        <input name="item_id" type="hidden" id="item_id" value="<?php echo $item_data[0]['ID'];?>"/>
                    </div>
                </div>
                <div class="form-group col-md-6 col-sm-6 col-xs-6">
              ...
              <?php foreach ($account_group as $row) {
                if($item_data[0]['Group_ID'] == $row['ID']) { 
                     echo "<option selected value='".$row['ID']."'>".$row['GROUPNAME']."</option>"; 
                }else{
                ...
                <label for="emirate" class="col-md-4 control-label">Item Code<span class="textspandata"></span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9" style="align:left;">
                        <input type="text" class="form-control input-sm" id="txt_item_code" name="txt_item_code" maxlength="10" value="<?php if($item_data[0]['ITEMCODE'] == 'NULL'){ echo '';} else { echo $item_data[0]['ITEMCODE'];}?>">
                    </div>
                </div>
                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-4 control-label">HSN/SAC Code<span class="textspandata"></span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9" style="align:left;">
                        <input type="text" class="form-control input-sm" id="txt_hsn_code" name="txt_hsn_code" maxlength="10" value="<?php if($item_data[0]['HSNCODE'] == 'NULL'){ echo '';} else { echo $item_data[0]['HSNCODE'];}?>">
                    </div>
                </div>
                        ...
                        <select name="cmb_unit" id="cmb_unit"  class="form-control input-sm">
                            <option value="" >Select Unit Type</option><?php
                              foreach ($unit as $data) {
                               if($item_data[0]['UNIT_ID'] == $data['ID']) {
                ...
                <label for="emirate" class="col-md-4 control-label">Opening Quanity<span class="textspandata"></span></label>
                    <div class="col-md-7 col-sm-7 col-xs-9" style="align:left;">
                        <input type="number" class="form-control input-sm" id="txt_opening_stock" name="txt_opening_stock" maxlength="10" value="<?php echo $item_data[0]['OPSTOCK'];?>"  min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                    </div>
                </div>
                ...
                <label for="emirate" class="col-md-4 control-label">Opening Value<span class="textspandata"></span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9" style="align:left;">
                        <input type="number" class="form-control input-sm" id="txt_opening_value" name="txt_opening_value" maxlength="12" value="<?php echo $item_data[0]['OPENINGVALUE'];?>"  min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                    </div>
                </div>                
                <div class="form-group col-md-6 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-4 control-label">Selling Rate<span class="textspandata"></span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9" style="align:left;">
                        <input type="number" class="form-control input-sm" id="txt_selling_rate" name="txt_selling_rate" maxlength="12" value="<?php echo $item_data[0]['SRATE'];?>"  min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                    </div>
                </div>
  ...
  $(document).ready(function() {
     ...
     $("#txt_item_name").blur(function () {
       var item_name = $(this).val();
        ...
        $.ajax({
            url  :"<?php echo site_url(); ?>/inventory/item_name_update",
