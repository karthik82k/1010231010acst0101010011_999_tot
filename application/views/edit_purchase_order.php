...
<div class="container category">        
  <div class="row">
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_purchaseorder" id="frm_purchaseorder" action="<?php echo site_url('entry/update_purchaseorder');?>" method="post" >
        <div class="textdata_myaccount">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <label for="emirate" class="col-md-12 control-label ">P.O. No<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="input-sm" id="txt_bill_no" name="txt_bill_no" style="font-size: 16px; width:100%; border: 1px solid #555555 !important;" value="<?php echo $po_no;?>" maxlength="35">
                      <input type="hidden" id="txt_ref_num" name="txt_ref_num" value="<?php echo $qt_ref_no;?>">
                       <input type="hidden" class="input-group date" id="txt_reference_date" name="txt_reference_date" value="<?php echo $qt_ref_date;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">P.O. Date<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm  input-group date" id="txt_date" name="txt_date" class="form-control" placeholder="dd-mm-yyyy" style="font-size: 16px;" value="<?php echo $po_date;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">Quotation Ref. No.<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm" id="txt_ref_num" name="txt_ref_num" class="form-control" value="<?php echo $qt_ref_no;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">Quote. Ref. Dt.<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm  input-group date" id="txt_reference_date" name="txt_reference_date" class="form-control" placeholder="dd-mm-yyyy" value="<?php echo $qt_ref_date;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">Credit Period<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm" id="txt_validity" name="txt_validity" class="form-control" value="<?php echo $credit_period;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">Vendors Code<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm" id="txt_vendor_code" name="txt_vendor_code" class="form-control" value="<?php echo $vendor_code;?>" maxlength="25">
                ...
                <label for="emirate" class="col-md-12 control-label ">Reference Project<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm" id="txt_project_ref" name="txt_project_ref" class="form-control" value="<?php echo $project_ref;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">Test Certificate Ref.<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm" id="txt_test_certificate" name="txt_test_certificate" class="form-control" value="<?php echo $test_certificate;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">Mode of Transportation<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                      <input type="text" class="form-control input-sm" id="txt_transport" name="txt_transport" class="form-control" value="<?php echo $mode_of_transport;?>">
                ...
                <label for="emirate" class="col-md-12 control-label ">Shipping Address<span class="textspandata"></span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                       <select name="cmb_shipping" id="cmb_shipping" class="input-sm" style="width:96%; border: 1px solid #555555 !important;">
                        ...
                        <?php foreach ($party_address as $row) {
                            if($shipping_id == $row['PartyAddress_ID']){
                              echo "<option value='".$row['PartyAddress_ID']."' selected>".$row['ADDRESS1']."</option>"; 
                            }else{
                              echo "<option value='".$row['PartyAddress_ID']."'>".$row['ADDRESS1']."</option>"; 
                            }                            
                          }?> 
                      </select>
                    </div>
                  ...
                  <div class="col-md-5 col-sm-9 col-xs-9" style="text-align:center; ;border-radius: 1px 1px 1px 1px; border: solid 1px #000000;  margin-top: 15px;">
                                    ...
                                    $check_so = '';
                                    if($order_type == 0){
                                      $check_po = 'checked="checked"';
                                    }else{
                                      $check_so = 'checked="checked"';
                                    }
                                      ?>
                                        <input type="radio" id="order_1" class="chk_gst" name="chk_type"  value="1" <?php echo $check_so;?> /> Sales Order</label>
                                         <label class="btn btn-default">
                                        <input type="radio" id="order_2" class="chk_gst" name="chk_type"  value="0" <?php echo $check_po;?>/> Purchase Order</label>
                                </div>
             ...
             <div class="form-group col-md-8 col-sm-6 col-xs-6">
                ...
                <label for="emirate" class="col-md-4 " style="width:250px">This Scheduled supply on / in between </label>
                    <div class="col-md-2 col-sm-9 col-xs-9" style="width: 108px; padding-right: 0px;padding-left: 0px;">
                      <input type="text" class="input-sm  input-group date" id="txt_delivery_from_date" name="txt_delivery_from_date" style="  border: 1px solid #555555 !important;"  placeholder="dd-mm-yyyy" value="<?php echo $delivery_from;?>">
                      ...
                      <input type="text" class="input-sm input-group date" id="txt_delivery_to_date" name="txt_delivery_to_date" placeholder="dd-mm-yyyy" style="border: 1px solid #555555 !important;" value="<?php echo $delivery_to;?>"> 
          ...
          <td>
             <input name="txt_hsn[]" type="text" class="tf10 addeb_input_txtfld input_grid" id="txthsn_<?php echo $j;?>" style="pointer-events: none;" value="<?php echo $value['HSNCODE'];?>" />
          </td>
          <td>
          ...
          <td>
              <select id="cmbunit_<?php echo $j;?>" name="cmb_unit[]" class="tf6 txtara_lst input_grid" style="width:75px; font-size: 12px; pointer-events: none;">
          ...
          <td>
              <input name="txt_qty[]" type="number" class="tf5 addeb_input_txtfld input_grid" id="txtqty_<?php echo $j;?>" value="<?php echo $value['QTY'];?>"   maxlength = "10" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
          </td>         
           <td>
              <input name="txt_unit_price[]" type="number" class="tf7 addeb_input_txtfld input_grid" id="txtunitprice_<?php echo $j;?>" value="<?php echo $value['RATE'];?>"   maxlength = "10" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
          </td>
          ...
          <td>
              <input name="txt_total[]" type="number" class="tf14 addeb_input_txtfld input_grid" id="txttotal_<?php echo $j;?>" value="<?php echo $value['AMOUNT'];?>" readonly style=" background-color: #f5f5f5;" />
          </td>
     ...
     <div class="col-md-12 col-sm-12 col-xs-12">               
              <div class="form-group col-md-9 col-sm-6 col-xs-6" >
                <label for="emirate" class="col-md-12 control-label">Terms and Conditions <span class="textspandata"></span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9">
                         <textarea name="txt_terms" id="txt_terms" cols="10" rows="5" class="txtarahg" style="height: 42px;width: 90%;"  maxlength="250"><?php echo $termsnconditions;?></textarea>
                    </div>
                </div> 
                <div class="form-group col-md-3 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label">GRAND TOTAL<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9">
                        <input name="txt_final_total" type="number" id="txt_final_total" class="input-sm" readonly style="    background-color: #f5f5f5; border: 1px solid #555555 !important; font-size: 16px;" value="<?php echo $total_final;?>">
                    </div>
                </div>
            </div>            
          </fieldset>      
            <div style="height:5px;"></div>
                  <div class="text-center">
                    ...
                    <input type="reset" class="btn btn-primary" name="reset" id="reset" value="Reset" />&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Cancel" onclick="window.location.href='<?php echo site_url('entry/manage_purchase_order');?>'" />&nbsp;&nbsp;<!--<input type="button" class="btn btn-primary" name="btn_delete" id="btn_delete" value="Delete"  onclick=" if (confirm('Do you want delete this Order?')){window.location.href='<?php echo site_url('/entry/delete_purchase_order/'.$prefix_voucher_id.'/'.'/?pre='.urlencode($prefix_voucher_type));?>';}else{event.stopPropagation(); event.preventDefault();}; "/> -->
                </div>          
            </div>  
        </form>       
    </div>    
