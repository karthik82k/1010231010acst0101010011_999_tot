...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">PURCHASE VOUCHER</li> 
      ...
      <tr>
        <td>
          <table width="100%" align="center" style="border:solid 1px black; " >
            <tr>
              <td style="padding-left:50px;text-align: center; font-size: 15px; font-family: Arial; font-weight: bold; width:70%; border:solid 1px black;">PURCHASE VOUCHER</td>
        ...
        <tr>
          <td style=" width: 50%">
            <table width="100%" style="font-family: Arial; font-size: 14px;">
              ...
              <tr>
                <td  style="font-weight:bold;">Purchase No:</td>
