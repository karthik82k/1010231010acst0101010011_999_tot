...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>EDIT JOURNAL VOUCHER</b></li>  
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
             <form name="frm_debit" id="frm_debit" action="<?php echo site_url('entry/update_journalvoucher');?>" method="post" >
        <div class="textdata_myaccount">
            ...
            <input type="hidden"  name="cmb_finance_year" id="cmb_finance_year" value="<?php echo $financial_year_id;?>">
                ...
                <label for="emirate" class="col-md-12 control-label">Journal Voucher No<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9"> 
                         <input type="text" class="input-sm" id="cmb_voucher_type" name="cmb_voucher_type" value="<?php echo $ref_prefix; ?>" readonly style="width:35%;    border: 1px solid #555555 !important;  background-color: #f5f5f5; font-size: 15px;" maxlength = "20">                    
                        <input type="text" class=" input-sm" name="txt_serial_no" id="txt_serial_no" value="<?php echo $ref_serial_no; ?>" readonly style="    border: 1px solid #555555 !important; width:54%;  background-color: #f5f5f5; font-size: 15px;">
                    </div>
                </div>
                ...
                <label for="emirate" class="col-md-12 control-label ">Reference No<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">
                       ...
                       <input type="text" class="form-control input-sm"  name="txt_bill_no"  id="txt_bill_no" maxlength="10" style="font-size: 16px;" value="<?php echo $refnum; ?>"> 
                    </div>
                </div>
                ...
                <label for="emirate" class="col-md-12 control-label">Reference Date<span class="textspandata">*</span></label>
                    <div class="col-md-11 col-sm-9 col-xs-9">                   
                       <input type="text" class="form-control input-sm  input-group date" id="txt_date" name="txt_date" class="form-control" placeholder="dd-mm-yyyy" style="font-size: 16px;" value="<?php echo $date; ?>">
                    </div>
                </div>
                </div>                               
          ...
          <tr class="to_clone1">
          <td>
            <select id="cmbledger_<?php echo $j;?>" name="cmb_ledger[]" class="tf4 form-control input-sm" style="width: 480px; font-size: 16px;" >
                        <option  value="">select Ledger</option>
                          <?php foreach ($ledger as $row) {
                              if($val['ACCOUNT_ID'] == $row['ID']){
          ...
          <td>
              <input name="amount[]" type="number" class="tf14 addeb_input_txtfld input_grid" id="amount_<?php echo $j;?>" value="<?php echo $val['AMOUNT'];?>"  maxlength = "10" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" style="font-size: 16px;" />
          </td>
          <td>
            <?php
            $selected_credit = '';
            $selected_debit = '';
              ...
              $credit_total = $credit_total + $val['AMOUNT'];
                $selected_credit = 'selected="selected"';
              }else if($val['TYPE'] == 'Debit'){
                $selected_debit = 'selected="selected"';
                $debit_total = $debit_total + $val['AMOUNT'];
              }
             ?>
             <select id="cmbtype_<?php echo $j;?>" name="cmb_type[]" class="tf13 form-control input-sm" style="font-size: 16px;" >                
     ...
     <div class="col-md-12 col-sm-12 col-xs-12">               
                ...
                <label for="emirate" class="col-md-12 control-label">TOTAL DEBIT AMOUNT<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9">
                        <input name="txt_debit_total" type="number" id="txt_debit_total" class="input-sm" readonly style=" background-color: #f5f5f5;    border: 1px solid #555555 !important; font-size: 16px;" value="<?php echo $debit_total;?>" >
                    </div>
                </div>
                <div class="form-group col-md-3 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label">TOTAL CREDIT AMOUNT<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9">
                        <input name="txt_credit_total" type="number" id="txt_credit_total" class="input-sm" readonly style=" background-color: #f5f5f5;    border: 1px solid #555555 !important; font-size: 16px;" value="<?php echo $credit_total;?>" >
                    </div>
                </div>
            </div>        
          </fieldset>      
            <div style="height:5px;"></div>
                  <div class="text-center">
                    ...
                    <input type="reset" class="btn btn-primary" name="reset" id="reset" value="Reset" />&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Cancel" onclick="window.location.href='<?php echo site_url('entry/manage_journal_voucher');?>'" />
                    &nbsp;&nbsp;<!--<input type="button" class="btn btn-primary" name="btn_delete" id="btn_delete" value="Delete"  onclick=" if (confirm('Do you want delete this voucher?')){window.location.href='<?php echo site_url('/entry/delete_journal_voucher/'.$ref_serial_no.'/'.'/?pre='.urlencode($ref_prefix));?>';}else{event.stopPropagation(); event.preventDefault();}; "/> -->
                </div>          
            </div>  
        </form>       
    </div>    
