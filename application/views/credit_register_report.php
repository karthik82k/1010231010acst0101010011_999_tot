...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">CREDIT NOTE REPORT</li>  
        ...
        <div class="textdata_myaccount">
            ...
            <div class="row" id="row1">
              <div class="col-md-12 col-sm-12 col-xs-12">            
                ...
                <label for="emirate" class="col-md-3 control-label" style="margin-left:0px; margin-bottom:0px; margin-top:0px; margin-right:0px; text-align:right; ">Credit Note for the Month <span class="textspandata">*</span></label>
           ...
           if(!empty($purchase_register_report)){
            ...
            <tr>
             ...
             <tr>
                ...
                <th class="no-sort">CREDIT NOTE NO</th>
                <th class="no-sort">ORIGINAL INVOICE NO</th>
                <th class="no-sort">ORIGINAL INVOICE DATE</th>
...
<script>
 $("#cmb_account_group").change(function(){ 
  var ledger = $('#cmb_account_group').val();
    window.location='<?php echo site_url(); ?>mis_report/creditnote_report/' + ledger;
  });
