...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">MANAGE GOODS RECIEVED NOTE</li> 
     ...
     if($islock != 1) {
      ?>
     <a href="<?php echo site_url('/inventory/goods_recieved_note');?>" alt="ADD GOODS RECIEVED NOTE" title="ADD GOODS RECIEVED NOTE"><img src="https://test.newui.myddf.info/images/add.png" alt="ADD GOODS RECIEVED NOTE" title="ADD GOODS RECIEVED NOTE"/> ADD GOODS RECIEVED NOTE</a>
      <?php
     }
     ?>
     </div>   
<table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>                
                <td><?php echo $val['GRNNO'];?></td>
                <td><?php echo date("d-m-Y H:i",strtotime($val['GRNDATETIME']));?></td>
                <td><?php echo $account_list[$val['ACCOUNT_ID']];?></td>
                <td><?php echo $financial_year_selected;?></td>
                <td><?php echo $val['Total'];?></td>
                <td><a href="<?php echo site_url('/inventory/edit_goods_recieve_note/'.$val['VOUCHER_ID'].'/?grn_no='.urlencode($val['GRNNO']));?>"><span class="fa fa-pencil-square-o"></span></a></td>
            </tr>
            <?php
        }
            ?>
