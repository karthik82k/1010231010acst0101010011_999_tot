...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>PAYABLE BILLWISE</b></li> 
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:1px 1px 1px 1px;">
            <form name="frm_sales_voucher" id="frm_sales_voucher" action="<?php echo site_url('mis_report/payable_billwise');?>" method="post" >
    ...
    <?php if(!empty($payable)){ ?> 
     <table  class="table table-striped table-bordered" cellspacing="0" width="100%">           
          <thead>
          <tr>
                <th class="no-sort" colspan="6" style="text-align: center; height: 65px; vertical-align: middle; font-size: 18px;"><?php echo $account[0]['ACCOUNTDESC'].'(Payable Billwise Details)';?></th>
            </tr>
        ...
        <tr>
                ...
                <td><?php $bal = $key['AGE'] - $key['CREDITPERIOD'];
                if($bal > 0){
                  echo $key['AGE'];
                }else{
                  echo 'No Due';
