...
<div class="container category" style="min-height: 560px;">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;">PURCHASE REGISTER REPORT</li>  
          ...
          <?php
           ...
           <tr>
            ...
            $domestic_dn_total = 0;
             ...
             foreach ($purchase_register_report as  $value_rep) {
              if($value_rep['PREFIX'] == 'Less Debit Note'){
                 $domestic_dn = 0;
             $interstate_dn = 0;
             $export_dn = 0;
             $total_dn = 0;
            ...
            $sez_total_dn = $sez_dn + $sez_total_dn;
             ...
             $total_igst_dn = $value_rep['IGSTAMOUNT']  + $total_igst_dn;
              ...
              if($value_rep['PREFIX'] == 'Add Credit Note'){
                $type = $value_rep['LEDGER'];
            ...
            $sez_total_cn = $sez_cn + $sez_total_cn;
             ...
             $total_igst_cn = $igst_cn + $total_igst_cn;
              ...
              if($value_rep['PREFIX'] == 'Less Payment'){
            ...
            <tr>
                <td colspan="5"><b>LESS PAYMENT</b></td>
             ...
             <tr style="font-weight: bold;">
                ...
                <?php
                }}elseif($month !='' && empty($purchase_register_report) ){
        ?>
