...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>Goods Received Note</b></li> 
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_salesorder" id="frm_salesorder" action="<?php echo site_url('inventory/add_goods_recieved_note');?>" method="post" >
        <div class="textdata_myaccount">
            ...
            <div class="form-group col-md-3 col-sm-6 col-xs-6">
                ...
                <label for="emirate" class="col-md-12 control-label">GRN No<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                        <input type="text" class="form-control input-sm " id="txt_crn_no" name="txt_crn_no" class="form-control" value="<?php echo $crn;?>">
                    </div>
                </div>
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label">GRN Date Time<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9">                   
                        <input type="text" class="form-control input-sm  input-group date" id="txt_crn_date_time" name="txt_crn_date_time" class="form-control" placeholder="dd-mm-yyyy" value="<?php echo $crn_date;?>">
                    </div>
                </div>
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                ...
                <label for="emirate" class="col-md-12 control-label ">Purchase Order No.<span class="textspandata">*</span></label>
                    <div class="col-md-12 col-sm-9 col-xs-9" style="align:left;">
                       <select name="cmb_po_number" id="cmb_po_number" class="input-sm" style="width:96%;    border: 1px solid #555555 !important;">
                        <option value="" selected="selected">Select Purchase Order No.</option>
                          <?php foreach ($purchase_order as $key) {
          ...
          <tr class="to_clone1">
          <td>
            <select id="cmbitemname_" name="cmb_item_name[]" class="tf4 txtara_lst input_grid" style="width:450px;" >
          ...
          <td>
              <select id="cmbunit_" name="cmb_unit[]" class="tf6 txtara_lst input_grid" style="width:110px;">
     ...
     <div class="col-md-12 col-sm-12 col-xs-12" style="float: right;">               
            ...
            <div style="height:5px;"></div>
                  <div class="text-center">
                    ...
                    <input type="reset" class="btn btn-primary" name="reset" id="reset" value="Reset" />&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Cancel" onclick="window.location.href='<?php echo site_url('inventory/manage_goods_recieved_note');?>'" />
                </div>          
            </div>  
        </form>       
    </div>    
...
$("#cmb_po_number").change(function(){
 ...
 $("#txt_crn_no").blur(function () {
       var bill_no = $(this).val();
        $.ajax({
            url  :"<?php echo site_url(); ?>/inventory/check_grn",
            data : {bill_no: bill_no},
            success: function(ret){              
              if(ret == 'exists') {
                jAlert("The GRN No is already exits!!", "Alert");
                $("#txt_crn_no").val('');
              }
            }
        })
