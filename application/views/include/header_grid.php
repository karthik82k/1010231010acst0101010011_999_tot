...
>>>>>>> master
                    ...
                    <li class="dropdown" >
                        ...
                        <ul class="dropdown-menu">                          
                            ...
                            <li>
                                <a href="<?php echo site_url('/mis_report/cancel_sales_report');?>" alt="Cancelled / Del Invoice Report" title="Cancelled / Del Invoice Report">Cancelled / Deleted Invoice Report</a>
                            </li>                                              
                        </ul>
                    </li>
                   <li class="dropdown" >
