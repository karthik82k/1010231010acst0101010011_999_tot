...
<div class="container category">        
  <div class="row">
    <ol class = "breadcrumb">                
        <li style="color: red;"><b>PROFORMA INVOICE</b></li> 
    ...
    <div class="col-md-12" style="background-color:#FFFACD;border-radius: 5px 5px 5px 5px; border: solid 1px #000000; padding:8px 8px 8px 8px;">
            <form name="frm_salesorder" id="frm_salesorder" action="<?php echo site_url('entry/add_salesquotation');?>" method="post" >
        <div class="textdata_myaccount">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">            
                ...
                <label for="emirate" class="col-md-12 control-label">Proforma Invoice Ref. No.<span class="textspandata">*</span></label>
                    <div class="col-md-11 col-sm-9 col-xs-9">                   
                       <input type="text" class="form-control input-sm"  name="txt_ref_num"  id="txt_ref_num"  maxlength = "15" style="font-size: 16px;"> 
                    </div>
                </div>
                <div class="form-group col-md-2 col-sm-6 col-xs-6">
                <label for="emirate" class="col-md-12 control-label">Reference Date<span class="textspandata">*</span></label>
                    <div class="col-md-11 col-sm-9 col-xs-9">                   
                       <input type="text" class="form-control input-sm  input-group date"   name="txt_ref_date"  id="txt_ref_date"   class="form-control" placeholder="dd-mm-yyyy" style="font-size: 16px;"> 
                    </div>
                </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <label for="emirate" class="col-md-12 control-label">Validity<span class="textspandata">*</span></label>
                    <div class="col-md-11 col-sm-9 col-xs-9">                   
                       <input type="text" class="form-control input-sm"  name="txt_validity"  id="txt_validity"  maxlength = "3" min = "0"  value="0" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" > 
                    </div>
                </div>
          ...
          <td style="width:350px;">
           ...
           <td>
             <input name="txt_hsn[]" type="text" class="tf10 addeb_input_txtfld input_grid" id="txthsn_" />
          </td>
          <td>
          ...
          <td>
              <select id="cmbunit_" name="cmb_unit[]" class="tf6 txtara_lst input_grid" style="width:75px; pointer-events: none;">
           ...
           <td>
              <input name="txt_unit_price[]" type="number" class="tf7 addeb_input_txtfld input_grid" id="txtunitprice_" value="0"   maxlength = "10" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" style="width:75px;"/>
          </td>
          <td>
              <input name="txt_qty[]" type="number" class="tf5 addeb_input_txtfld input_grid" id="txtqty_" value="0"   maxlength = "10" min = "0"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" style="width:75px;"/>
          </td>
          
          <td>
              <input name="txt_total[]" type="text" class="tf14 addeb_input_txtfld input_grid" id="txttotal_" value="0" readonly style=" background-color: #f5f5f5; width:100px;" />
          </td>
     ...
     <div class="col-md-12 col-sm-12 col-xs-12">  
              <div class="form-group col-md-9 col-sm-6 col-xs-6" >
                <label for="emirate" class="col-md-12 control-label">Terms and Conditions <span class="textspandata"></span></label>
                    <div class="col-md-10 col-sm-9 col-xs-9">
                         <textarea name="txt_terms" id="txt_terms" cols="50" rows="5" class="txtarahg" style="height: 42px; width: 100%;"  maxlength="250"></textarea>
                    </div>
                </div>    
                ...
                <label for="emirate" class="col-md-12 control-label">GRAND TOTAL<span class="textspandata">*</span></label>
                    <div class="col-md-7 col-sm-9 col-xs-9">
                        <input name="txt_final_total" type="number" id="txt_final_total" class="input-sm" readonly style="    border: 1px solid #555555 !important;  background-color: #f5f5f5; font-size: 16px;" >
                    </div>
                </div>
            </div>            
          </fieldset>      
            <div style="height:5px;"></div>
                  <div class="text-center">
                    ...
                    <input type="reset" class="btn btn-primary" name="reset" id="reset" value="Reset" />&nbsp;&nbsp;<input type="button" class="btn btn-primary" name="reset" id="reset" value="Cancel" onclick="window.location.href='<?php echo site_url('entry/manage_sales_quotation');?>'" />
                </div>          
            </div>  
        </form>       
    </div>    
